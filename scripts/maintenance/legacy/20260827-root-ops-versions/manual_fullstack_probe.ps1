...
$replace=@{SCP_ENV_FILE=$EnvFile;SCP_SIDECAR_ENV_FILE=$EnvFile;SCP_EGRESS_MODE='deny';SCP_SKIP_STARTUP_GATE='1';SCP_BASE_URL='http://127.0.0.1:8000';LLM_BRIDGE_URL='http://127.0.0.1:11435'}
