...
5. **Continuous Verification:** Sau mỗi chỉnh sửa code, bắt buộc chạy `run_reality_tests_portable.py` (74/74) và pytest để đảm bảo không có bất kỳ regression nào.
