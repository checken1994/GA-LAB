...
def test_openrouter_timeout_recovers_via_task_free_fallback() -> None:
    ...
    assert calls[:2] == [os.environ.get("OPENROUTER_MODEL", "deepseek/deepseek-v4-flash-0731"), os.environ.get("OPENROUTER_MODEL_JUDGE", "nvidia/nemotron-3-super-120b-a12b:free")]
