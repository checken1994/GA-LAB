...
| M13 | Data sources & Learning | `tests/T03_capability/test_flow_13_free_api_learning_scp_standard.py` | **đã** — 28 passed tại pin `76b7624…`; P1–P6 probe (consolidate 200, top-systems fetch GitHub/Wikipedia thật) | **CLOSED_WITH_KNOWN_GAP** (`M13-closure.json`, pin `76b7624…`; D4/D5 = PASS_WITH_LIMITS). **Cập nhật 2026-09-12 (EE/S13):** egress enforcement shipped (commits `61d068f..eb25959` — choke point safe_urlopen + 3 fetcher + static gate; V-EE verified runtime reversal: deny blocks example.com); 2 residual Session-bypass REMEDIATED by S13 (`91076a6`/`38cf2fc`, tests `4ffd15b` — đọc `reports/expert-panel/EE-egress-enforcement.md` § V-EE-remediation) |
