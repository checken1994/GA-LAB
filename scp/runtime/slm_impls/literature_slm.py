"""
[OPT-15] LiteratureSLM — DomainExpert for literature (uses Gutenberg).
    ...
    def predict(self, question: str) -> SLMResponse:
        ...
        if not answer and self._gutenberg and self._gutenberg.enabled:
            try:
                ...
                logger.debug(f"LiteratureSLM Gutenberg query: {e}")
...
LiteratureExpert = LiteratureSLM
