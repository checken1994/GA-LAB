"""
[OPT-22] EngineeringSLM — DomainExpert for engineering
...
class EngineeringSLM(BaseSLM):
    ...
    def __init__(self, config: Optional[dict] = None):
        super().__init__(name="EngineeringSLM", domain="engineering", config=config)
        ...
        for ds_module, ds_class_name in [
            ...
            try:
                ...
                logger.debug(f"EngineeringSLM {ds_class_name} init: {e}")
                ...
                if entity:
                    for ds in self._data_sources:
                        ...
                        try:
                            ...
                            logger.debug(f"EngineeringSLM {ds_name} fetch: {e}")
            except Exception as e:
                logger.debug(f"EngineeringSLM entity extraction: {e}")
...
EngineeringExpert = EngineeringSLM
