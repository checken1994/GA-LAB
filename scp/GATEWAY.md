...
# Start SCP:
cd /home/z/my-project && python3 -m scp
```

The Next.js dashboard `/api/scp/health` route will return
`{ "scp": "offline", "hint": "Run: cd /home/z/my-project && python3 -m scp 8000" }`
...
- `/home/z/my-project/scp/.env.example` — every env var SCP reads
- `/home/z/my-project/scp/__main__.py` — SCP entry point
- `/home/z/my-project/scp/api_server.py` — FastAPI app + route definitions
- `/home/z/my-project/Caddyfile` — the gateway config (24 lines)
